  ...
  return (
    <div className="layout__outlet ng-tns-c274-0">
      ...
      <div className="ng-tns-c274-0 ng-trigger ng-trigger-chatLayoutAnimation">
        ...
        <app-privacy _nghost-stx-c281 className="ng-star-inserted">
          <div _ngcontent-stx-c281 className="content content--center">
            <section
              _ngcontent-stx-c281
              tabIndex={-1}
              className="main-content content__main content__main--small content__main--center"
            >
              <div _ngcontent-stx-c281 className="content__headline">
                <h2 _ngcontent-stx-c281>Privacy Policy</h2>
              </div>
              <hr _ngcontent-stx-c281 />
              <div _ngcontent-stx-c281 className="mobile-clearance">
                <p>
                  At Prep Sports Recruiting, accessible from
                  www.prepsportsrecruiting.com, one of our main priorities is
                  the privacy of our visitors. This Privacy Policy document
                  contains types of information that is collected and recorded
                  by Prep Sports Recruiting and how we use it.
                </p>
                <p>
                ...
                <p>
                  ...
                  information that they shared and/or collect in Prep Sports
                  Recruiting. This policy is not applicable to any information
                ...
                <h4>Log Files</h4>
                <p>
                  Prep Sports Recruiting follows a standard procedure of using
                ...
                <p>
                  Like any other website, Prep Sports Recruiting uses 'cookies'.
                ...
                <p>
                  ...
                  of the advertising partners of Prep Sports Recruiting.
                </p>
                <p>
                  Third-party ad servers or ad networks use technologies like
                  cookies, JavaScript, or Web Beacons that are used in their
                  respective advertisements and links that appear on Prep Sports
                  Recruiting, which are sent directly to users' browser. They
                ...
                <p>
                  Note that Prep Sports Recruiting has no access to or control
                  over these cookies that are used by third-party advertisers.
                </p>
                <h4>Third Party Privacy Policies</h4>
                <p>
                  Prep Sports Recruiting's Privacy Policy does not apply to
                ...
                <p>
                  Prep Sports Recruiting does not knowingly collect any Personal
