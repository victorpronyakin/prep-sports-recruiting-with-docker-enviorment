...
import { getBlogs, getNextPosts } from "../../api/blog.api";
...
const Blog = ({ match }) => {
  ...
  const [featuredArticles, setFeaturedArticles] = useState(initialState);
  ...
  //   const response = await getNextPosts(lastPostId, 1);
  //   console.log("LOAD MORE RESPONSE:", response);
  //   // const addedPosts = featuredArticles.concat();
  //   // setFeaturedArticles();
  // };
...
const PostsList = ({ posts = [], isLoading = false, loadMore }) => {
  return (
                ...
                <p className="entry-meta">
                  ...
                  <span className="entry-author">
                    <a
                      ...
                      rel="author"
                    >
                      <span className="entry-author-name">Taylor Lambert</span>
                    </a>
                  </span>
                </p>
              </header>
                ...
                <header className="entry-header">
                  <h4 className="entry-title">
                    <a href="https://www.fantraxhq.com/top-25-tampa-bay-rays-prospects-2020/">
                      <span className="category">Dynasty Fantasy Baseball</span>
                    </a>
                  </h4>
                  <h4 className="entry-title" itemProp="headline">
                    {/* eslint-disable-next-line */}
                  ...
                  <p className="entry-meta">
                    <time className="entry-time">April 26, 2020</time> By{" "}
                    <span className="entry-author">
                      <a
                        ...
                        rel="author"
                      >
                        <span className="entry-author-name">Eric Cross</span>
                      </a>
                    </span>{" "}
                ...
                <header className="entry-header">
                  <h4 className="entry-title">
                    <a href="https://www.fantraxhq.com/how-should-dynasty-football-leagues-handle-the-2020-nfl-supplemental-draft/">
                      <span className="category">dynasty fantasy football</span>
                    </a>
                  </h4>
                  <h4 className="entry-title" itemProp="headline">
                    {/* eslint-disable-next-line */}
                    <a href="https://www.fantraxhq.com/how-should-dynasty-football-leagues-handle-the-2020-nfl-supplemental-draft/" />
                    <a href="https://www.fantraxhq.com/how-should-dynasty-football-leagues-handle-the-2020-nfl-supplemental-draft/">
                      How Should Dynasty Football Leagues Handle the 2020 NFL
                      Supplemental Draft?
                    </a>
                  </h4>
                  <p className="entry-meta">
                    <time className="entry-time">April 27, 2020</time> By{" "}
                    <span className="entry-author">
                      <a
                        ...
                        rel="author"
                      >
                        <span className="entry-author-name">Meng Song</span>
                      </a>
                    </span>{" "}
                    <span className="entry-comments-link">
